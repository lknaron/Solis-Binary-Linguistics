...
programChair.controller('programChairEvalController', function($scope, $http, $location, $route, UserInfoService) {
...
// View Applications
programChair.controller('programChairSearchAppController', function($scope, $location, $http) {
    $http.post('/programChair/applicationNames').then(function successCallback(response) {
...
programChair.controller('programChairStudentInfoController', function($scope, $routeParams, $http) {
